...
Examples:
    ...
    # Evaluate a angstromchat model (e.g. d24) using 8 GPUs
...
from angstromchat.common import get_base_dir, download_file_with_lock, print0
from angstromchat.core_eval import evaluate_task
